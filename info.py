...
# Filter Words - common noise words stripped from search queries when no results found
# These words are commonly typed by users but are NOT present in file names
# When a search returns 0 results, these words are removed and search is retried
DEFAULT_FILTER_WORDS = {
    # Common noise words
    'movie', 'movies', 'download', 'downloads', 'free', 'full',
    'watch', 'online', 'film', 'films', 'hd', 'print', 'series',
    'show', 'telegram', 'link', 'get', 'send', 'please', 'plz',
    'pls', 'want', 'need', 'give', 'new', 'latest', 'bot', 'file',
    'files', 'quality', 'video',
    # "movie/movies" misspellings
    'moive', 'moives', 'mvie', 'mvies', 'movi', 'movei', 'moovie',
    'moovies', 'movue', 'movir', 'move', 'muvi', 'muvie', 'muvies',
    'mobie', 'mobies', 'movy',
    # "download" misspellings
    'downlod', 'dowload', 'donload', 'dawnload', 'downlaod', 'dowmload',
    'dowmlod', 'donwload', 'dwnload', 'downloa', 'donlod', 'dounload',
    'downlad', 'dowbload', 'downoad',
    # "please" misspellings
    'plese', 'pleas', 'plez', 'plzz', 'pleese', 'plss', 'plsss', 'pleass',
    # "watch" misspellings
    'wach', 'wtach', 'wacth', 'wath',
    # "free" misspellings
    'fre', 'frea', 'frei', 'freee',
    # "film" misspellings
    'flim', 'flims', 'fillm',
