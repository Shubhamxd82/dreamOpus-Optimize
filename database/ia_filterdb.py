...
async def _perform_search(query, file_type, max_results, offset):
    ...
    # Run count and find in parallel instead of sequentially (2x faster)
...
async def get_search_results(chat_id, query, file_type=None, max_results=10, offset=0, filter=False):
    ...
    files, next_offset, total_results = await _perform_search(query, file_type, max_results, offset)
